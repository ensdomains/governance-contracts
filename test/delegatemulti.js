  ...
  describe('deposit', () => {
    ...
    it('should revert if upper 96 bits of target uint256 is not zero', async () => {
      ...
      await expect(
        ...
        'InvalidDelegateAddress(115339776388732929035197660849917252472676939519258848623682632494078702215427)'
      );
    });
  });
  ...
  describe('re-deposit', () => {
    ...
    it('should revert if upper 96 bits of source uint256 is not zero', async () => {
      ...
      await expect(
        ...
        'InvalidDelegateAddress(115339776388732929035197660849888570009004220556316786536417127903990864487014)'
      );
    });
  });
